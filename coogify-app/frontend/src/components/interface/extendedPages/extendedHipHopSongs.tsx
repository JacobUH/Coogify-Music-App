...
export const ExtendedHipHopSongs = ({ title }: Props) => {
  ...
  useEffect(() => {
    ...
    const fetchHipHopSongs = async () => {
      try {
        const response = await axios.get(
          `${backendBaseUrl}/api/home/fetchHipHopSongs`,
          {
            headers: {
        ...
        console.error('Error fetching HipHop songs:', error);
      }
    };
