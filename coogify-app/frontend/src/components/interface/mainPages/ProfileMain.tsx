...
export const ProfileMain = () => {
  ...
  const dateOfBirthHasValue =
    profile.length > 0 && profile[0].dateOfBirth !== '';
                ...
                <div className="flex flex-col gap-4 w-full">
                  ...
                  {profile.length > 0 && profile[0].isArtist === 1 && (
                    <div className="flex flex-col mt-4">
                      ...
                      <input
                        ...
                        onChange={
                          isEditMode
                            ? (e) => setArtistName(e.target.value)
                            : undefined
                        }
                      />
                    </div>
                  ...
                  <div className="text-center mt-6">
                    {!isEditMode && (
                      <button
                        onClick={handleEdit}
                        className="bg-[#875ABE] hover:bg-[#5f3c8b] rounded-[20px] text-white font-bold py-2 px-20"
                      >
                        Edit
                      </button>
                    )}
