...
import { ExtendedAlternativeSongs } from '../extendedPages/extendedAlternativeSongs';

export const AlternativeSongsMain = () => {
      ...
      <div className="bg-gradient-to-t from-[#3E3C3C] from-85% to-[#9E67E4] to-100% rounded-md overflow-auto relative">
        ...
        <div className="w-full rounded-xl md:h-[calc(100vh-140px)] h-auto flex flex-col items-center gap-5 px-5 md:py-5 pb-20 pt-5">
          ...
          <div className="w-full flex justify-center items-center">
            <ExtendedAlternativeSongs title="Alternative Songs" />
          </div>
        </div>
      </div>
    </div>
